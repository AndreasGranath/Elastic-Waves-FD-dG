...
uex=@(t,x,y) [S_FD(t,x,y);S_dG(t,x,y)];
...
[TN_FD,TN_FD_tt,TS_FD,~,TE_FD,TE_FD_tt,~,~,f_FD,f_FD_tt]=TractionAssembler(uFD1,uFD2,mu1,lambda1,rho1);
[TN_dG,~,TS_dG,TS_dG_tt,TE_dG,TE_dG_tt,~,~,f_dG,f_dG_tt]=TractionAssembler(vdG1,vdG2,mu2,lambda2,rho2);
...
%[su_11,su_12,su_22,su_11_tt,su_12_tt,su_22_tt,~,~]=StressTensorAssembler(e1,e2,mu1,lambda1,rho1);
%[sv_11,sv_12,sv_22,sv_11_tt,sv_12_tt,sv_22_tt,~,~]=StressTensorAssembler(e1,e2,mu2,lambda2,rho2);
