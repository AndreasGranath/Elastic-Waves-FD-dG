...
function [PA2B,PB2A]=new_make_projectionCoeffs_good_bad(na,order)
...
EQN1=[eqn1;eqn2;eqn3;eqn4(Nb2+1:end-Nb2)];
EQN2=[eqn5;eqn6;eqn7(Nb1+1:end-Nb1);eqn8(Nb1+1:end-Nb1)];
...
save("good_bad_Coeffs_3rd_order_EigAccuracy_Flattening_Fminsearch.mat","Block1","Block2","Interior","Nb1","Nb2","Nh","No")
